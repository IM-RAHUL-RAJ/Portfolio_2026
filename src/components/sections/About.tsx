...
const stats = [
  { icon: Code2, value: 100, suffix: '+', label: 'Projects Built' },
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
              ...
              <div className="p-6 font-mono text-sm leading-relaxed">
                ...
                <div className="pl-4 mt-2">
                  <div>
                    ...
                    <span className="text-green-400">"Rahul Raj"</span>,
                  </div>
                  ...
                  <div>
                    ...
                    <span className="text-green-400">
                      "Crafting scalable, intuitive, production-grade and intelligent applications"
                    </span>,
                  </div>
          ...
          >
            <h3 className="text-2xl md:text-3xl font-bold font-mono mb-6">
              Crafting <span className="text-primary">Smart</span> & Scalable Solutions
            </h3>
