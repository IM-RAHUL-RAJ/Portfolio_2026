...
import { Brain, Code, Database, Layout, Users, Wrench } from 'lucide-react';
...
const skillCategories = [
  ...
  },
  {
    ...
    icon: Layout,
    skills: ['Springboot','Angular', 'Node.js', 'Express', 'Django','Streamlit','Tailwind CSS' ],
  },
  {
    title: 'Testing Frameworks',
    icon: Brain,
    skills: ['JUnit', 'Jest', 'Karma', 'Cypress', 'Playwright'],
  },
  {
    title: 'Databases',
    icon: Database,
    skills: ['PostgreSQL', 'MongoDB', 'MySQL', 'Snowflake','ETL tools'],
  },
  {
    title: 'DevOps & Cloud',
    icon: Wrench,
    skills: ['AWS (S3, RDS, EC2, EKS, Lambda)', 'Docker', 'Kubernetes', 'Jenkins', 'ControlM','Monitoring','Observability'],
  },
  {
    title: 'Soft Skills',
    icon: Users,
    skills: ['Problem Solving', 'Mentoring', 'Leadership','Communication', 'Team Work', 'Adaptability'],
  },
];
