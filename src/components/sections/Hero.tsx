...
export const Hero = () => {
  ...
  useEffect(() => {
    if (loopCount >= 3) {
      setTypedText(fullText); // ensure full text is shown
      setIsDone(true);        // stop cursor
      return;
    }
  ...
  {!isDone && <span className="animate-pulse">|</span>}
            ...
            >
              I enjoy building systems that are functional, scalable, distributed, fast, and visually appealing. From frontend interfaces to backend systems, I work across the full stack — from development and testing to deployment on cloud platforms.

Alongside building, I actively educate and share knowledge about the lifecycle of software systems, simplifying complex concepts into practical, real-world understanding.

My curiosity drives me toward AI and Machine Learning, where I explore data-driven solutions and automation. Problem solving is at the core of my work — finding elegant solutions to complex challenges is what motivates me. 
            </motion.p>
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96">
              ...
              <motion.div
                ...
                animate={{ opacity: 1, x: 0 }}
                transition={{ delay: 0.8 }}
                className="absolute -right-8 top-0 bg-card border border-border rounded-lg px-4 py-2 shadow-card"
              >
                <code className="text-xs font-mono text-primary">{'<Educator />'}</code>
              </motion.div>
